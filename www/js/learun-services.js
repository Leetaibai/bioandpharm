angular.module('starter.services', [])
  ...
  .factory('$learunPageModal',['$ionicModal',function($ionicModal){
    var pageModel = null;
    return function(scope,templateUrl,fnMethod){
  ...
  .factory('$learunGetDataItem',['$learunHttp','ApiUrl',function($learunHttp,ApiUrl){
    return function (ops) {
      $learunHttp.post({
        ...
        "success": function (data) {
          var lsdata = {};
          var bgColorList = ["positive-bg","royal-bg","balanced-bg","energized-bg","assertive-bg","calm-bg","dark-bg","dark-bg","dark-bg","dark-bg","dark-bg"];
